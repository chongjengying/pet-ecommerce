    ...
    <div className="space-y-2">
      ...
      <div className="flex flex-wrap gap-2 rounded-2xl border border-slate-200 bg-slate-50 p-2">
        ...
        <input
          ...
          className="min-w-[12rem] flex-1 bg-transparent px-2 py-1.5 text-sm text-slate-700 outline-none placeholder:text-slate-400"
        />
        <button
          type="button"
          onClick={addItem}
...
export default function AdminProductForm({ mode, product, categoryOptions }: AdminProductFormProps) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5 rounded-3xl border border-slate-200 bg-white p-5 shadow-[0_6px_16px_-12px_rgba(15,23,42,0.55)]">
      <div className="grid gap-4 md:grid-cols-2">
        <label className="space-y-1">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm outline-none transition focus:border-cyan-300 focus:bg-white"
          />
      ...
      <div className="flex flex-wrap items-center justify-end gap-3 border-t border-slate-100 pt-4">
        ...
        <button
          ...
          className="rounded-2xl bg-gradient-to-b from-cyan-600 to-teal-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:from-cyan-700 hover:to-teal-700 disabled:opacity-60"
        >
